...
const JobAnnouncerRegistrationView: React.FC<JobAnnouncerRegistrationViewProps> = ({ onNavigate }) => {
    ...
    const completion = useMemo(() => {
        ...
        // Optional field `area` adds to the count if filled
        const totalFields = fields.length + (formData.area ? 1 : 0);
        const filledFields = filledCount + (formData.area ? 1 : 0);
